...
// Licensed under the BSD 3-Clause license
    ...
    public:
        ...
        typedef EnergyType ( *FncSmoothCost)(NodeID, NodeID, LabelID, LabelID);
...
#pragma omp parallel for reduction(+:energy)
            ...
            for (int_t edgeID = 0; edgeID < (int_t) edges.size(); ++edgeID) {
                ...
                energy += fncSmoothCost(edge.nodeID1, edge.nodeID2, nodes[edge.nodeID1].label,
...
//                DEBUG_ULTIMATE("\t%2u. e: %g\td: %g\tt: %s", i, last_energy, diff, TD_TIMER_GET_FMT().c_str());
                printf("\t%2u. e: %g\td: %g\t", i, last_energy, diff);
